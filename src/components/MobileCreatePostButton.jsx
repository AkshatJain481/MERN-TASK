...
function MobileCreatePostButton() {
  return (
    ...
    <div className='max-sm:fixed bottom-0 right-0  mb-4 mr-4 sm:hidden'>
            <div className=' h-[54px] w-[54px] rounded-full flex items-center justify-center ' style={{background: 'linear-gradient(180deg, #FF5C5C 0%, #F0568A 100%)' }}>
