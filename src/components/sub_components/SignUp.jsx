...
function SignUp({onClose}) {
  ...
  const togglePasswordVisibility = () => {
    ...
    return (
      ...
      <div className="fixed inset-0    bg-black   bg-opacity-50 z-50 max-lg:hidden">
        ...
        <div className="text-center">
          ...
          <h2 className="text-2xl font-bold text-center mb-4 ">Create Account</h2>
            ...
            <p className="text-sm text-gray-600">Already have an account? <button onClick={openModal} className="text-blue-600">Sign In</button></p>
            </div>
          ...
          <p className="text-[11px] text-gray-600 mt-4 text-center px-4">By signing up, you agree to our Terms & conditions, Privacy policy</p>
        </div>
        </div>
        </div>
        <button 
      ...
      <div className="bg-white p-6 rounded-lg shadow-xl max-w-sm w-full flex flex-col max-[420px]:self-end max-[420px]:-mb-4  ">
        ...
        <div className="mt-4 ">
          ...
          <p className="text-xs text-gray-600 mt-4 text-center px-10">
            By signing up, you agree to our <a href="#" className="text-blue-600">Terms & conditions</a>, <a href="#" className="text-blue-600">Privacy policy</a>
          </p>
        </div>
      </div>
    </div>
    {isModalOpen ? (<SignIn  onClose={onClose} openModal={openModal} />):(<> </>)}
      </>
    );
  }
