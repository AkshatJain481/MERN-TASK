...
function PostSectionNavbar() {
    ...
    return (
      ...
      <nav className="flex sm:border-b justify-between  ">
        ...
        <button className="px-4 py-2 bg-gray-200 text-black font-semibold rounded hover:bg-gray-300 flex space-x-2">
            <span className='max-lg:hidden' >Write a Post</span> 
            <span className='lg:hidden'>Filter:All</span>
        ...
        <button className="px-4 py-2 bg-blue-600 text-white font-semibold rounded hover:bg-blue-700 flex items-center space-x-2 flex max-sm:hidden">
        <svg width="22" height="22" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
